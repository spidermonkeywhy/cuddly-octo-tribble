...
export function MenuIcon({ className }: IconProps) {
  return (
    <svg className={cn('w-6 h-6', className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
export function CopyIcon({ className }: IconProps) {
  return (
    <svg className={cn('w-4 h-4', className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
export function SearchIcon({ className }: IconProps) {
  return (
    <svg className={cn('w-5 h-5', className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
